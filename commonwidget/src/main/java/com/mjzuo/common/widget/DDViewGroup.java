package com.mjzuo.common.widget;
...
import com.mjzuo.common.R;
import com.mjzuo.common.Utils;

/**
 * 仿滴滴首页嵌套滑动ViewGroup。
 *
 * <p>有问题可GitHub反馈:
 * https://github.com/MingJieZuo/CustomViewCollection
 *
 * @author mjzuo
 * @Date 2020/06/13
 */
public class DDViewGroup extends ViewGroup {
    ...
    public DDViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DDViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeaderResId = array.getResourceId
                (R.styleable.DDViewGroup_header_id, -1);
        mTargetResId = array.getResourceId
                (R.styleable.DDViewGroup_target_id, -1);
        mInnerScrollId = array.getResourceId
                (R.styleable.DDViewGroup_inn_id, -1);
